...
def generate_quote() -> str:
    ...
    for attempt in range(6):
        ...
        prompt = (
            ...
            "- نص واحد قصير نسبياً (لا يتجاوز 15 كلمة)، مكتمل المعنى تماماً من أوله لآخره، وينتهي نهاية واضحة وقوية "
            "(لا ينتهي بحرف عطف أو جر مثل 'و' أو 'في' أو 'من' وما شابه).\n"
            "- التزم بجملة واحدة مكتملة، لا تحاول إطالتها أو إضافة بيت ثانٍ.\n"
